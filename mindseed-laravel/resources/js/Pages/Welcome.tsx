        ...
        <div className="min-h-screen flex flex-col bg-[var(--bg-main)] text-[var(--text-main)] transition-colors duration-300">
            ...
            <header className="flex items-center justify-between p-6 max-w-7xl mx-auto w-full">
                ...
                <div className="flex gap-4">
                    <Link href={route('login')} className="px-5 py-2 rounded-full font-semibold bg-[var(--accent-primary)] text-white hover:opacity-90 transition-opacity shadow-[0_4px_14px_0_var(--accent-primary)] shadow-opacity-40">
                        Acessar Plataforma
                    </Link>
                </div>
            </header>
            ...
            <main className="flex-1 flex flex-col items-center justify-center text-center px-6 py-20 max-w-5xl mx-auto w-full">
                ...
                <div className="flex flex-col sm:flex-row gap-4 w-full justify-center">
                    <Link href={route('login')} className="px-8 py-4 rounded-full font-bold text-lg bg-[var(--text-main)] text-[var(--bg-main)] hover:scale-105 transition-transform inline-block">
                        Conhecer Plataforma
                    </Link>
