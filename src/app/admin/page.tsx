                ...
                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6 mb-8">
                    ...
                    <div className="card-glass p-5 rounded-2xl flex flex-col justify-between">
                        <div className="flex justify-between items-start mb-2">
                            <div>
                                <p className="text-xs text-[var(--text-muted)] font-semibold uppercase tracking-wider mb-1">Estabilidade Emocional</p>
                                <h3 className="text-2xl font-bold font-sans">82%</h3>
                            </div>
                    ...
                    <div className="card-glass p-5 rounded-2xl flex flex-col justify-between bg-gradient-to-br from-[var(--bg-card)] to-[var(--bg-main)]">
                        <div className="flex justify-between items-start mb-2">
                            <div>
                                <p className="text-xs text-[var(--text-muted)] font-semibold uppercase tracking-wider mb-1">Atletas em Atenção</p>
                                <h3 className="text-2xl font-bold font-sans text-[var(--danger)]">3</h3>
                            </div>
                        </div>
