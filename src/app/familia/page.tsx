...
export default function FamilyHome() {
    return (
        <div className="p-4 md:p-8 max-w-4xl mx-auto w-full flex flex-col gap-6">
            ...
            <div>
                <h2 className="text-2xl font-bold font-sans">Bem-vindo, Marcos 👋</h2>
            ...
            <div className="card-glass p-6 rounded-2xl flex items-center justify-between">
                <div className="flex items-center gap-4">
                    <img src="https://ui-avatars.com/api/?name=Caio+Silva&background=1E293B&color=fff" alt="Caio" className="w-16 h-16 rounded-full border-2 border-[var(--border-color)]" />
                    <div>
                        <h3 className="font-bold text-lg">Caio Silva</h3>
                        <p className="text-sm text-[var(--text-muted)]">Sub-17 • Clube Master</p>
                    </div>
                </div>
