    ...
    return (
        <div className="p-4 md:p-8 max-w-5xl mx-auto w-full flex flex-col gap-6">
            ...
            <div className="flex justify-between items-end">
                <div>
                    <h2 className="text-2xl font-bold font-sans">Olá, Lucas 👋</h2>
            ...
            <div className="bg-gradient-to-r from-[var(--accent-primary)] to-[var(--accent-secondary)] rounded-2xl p-6 text-white shadow-lg relative overflow-hidden">
                <div className="relative z-10 flex flex-col md:flex-row justify-between items-center gap-4">
                    ...
                    <button className="w-full md:w-auto px-6 py-3 bg-white text-[var(--accent-primary)] font-bold rounded-full shadow-md hover:scale-105 transition-transform">
                        Iniciar Assessment
                    </button>
                </div>
                {/* Background art */}
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <div className="card-glass p-4 rounded-2xl flex flex-col items-center justify-center relative overflow-hidden text-center h-40">
                    ...
                    <span className="text-2xl font-bold mt-auto z-10 relative bottom-1">78<span className="text-sm">%</span></span>
                </div>
                ...
                <div className="card-glass p-4 rounded-2xl flex flex-col items-center justify-center relative overflow-hidden text-center h-40">
                    ...
                    <span className="text-2xl font-bold mt-auto z-10 relative bottom-1">65<span className="text-sm">%</span></span>
                </div>
